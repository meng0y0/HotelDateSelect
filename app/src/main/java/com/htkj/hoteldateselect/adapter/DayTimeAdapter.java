package com.htkj.hoteldateselect.adapter;
...
import com.htkj.hoteldateselect.MainActivity;
import com.htkj.hoteldateselect.R;
import com.htkj.hoteldateselect.bean.DayTimeEntity;
import com.htkj.hoteldateselect.bean.UpdataCalendar;
import com.htkj.hoteldateselect.holder.DayTimeViewHolder;
    ...
    public void onBindViewHolder(final DayTimeViewHolder holder, final int position) {
        ...
        if (dayTimeEntity.getDay() != 0) {
            if (dayTimeEntity.getStatus() == 100) {
                ...
                holder.select_txt_day.setTextColor(Color.parseColor("#c3c3c3"));
